...
print(df.head(2))
print(df.tail(2))
# �ZET: Verileri Excel tablosu gibi y�netmemizi sa�layan Pandas k�t�phanesi ile DataFrame (tablo) olu�turma, veriye eri�im ve h�zl� istatistiksel �zet ��karma tekniklerini kavr�yoruz.
